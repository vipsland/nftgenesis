 ...
 *   using the `setMerkleRoot` function defined in {RT}.sol contract. For this script to work your contract
...
async function main() {
  ...
  const prtContract = await prtFactory.attach(`${config.contractAddress}`)// Deployed contract address
  ...
  await prtContract.setMerkleRoot(root)
